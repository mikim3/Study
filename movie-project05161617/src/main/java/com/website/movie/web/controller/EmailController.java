    ...
    public void sendmail(UserDto user) throws MessagingException {
        ...
        emailcontent.append(
                " <div" 																																																	+
                        ...
                        "	href=\"http://localhost:8080/user/email/certified?nickname=" + user.getNickname() + "&certified=" + user.getCertified() + "\" target=\"_blank\">"														+
                        "		<p"																																																	+
        ...
        emailcontent.append("</body>");
        emailcontent.append("</html>");
        emailService.sendMail(user.getNickname(), "[12수2022 이메일 인증]", emailcontent.toString());
    }
